...
const standorte = [
  {
    ...
    description: "Unser Elektrofachgeschäft im Herzen von Murau. Persönliche Beratung, Top-Marken zum Anfassen und ein kompetentes Team – alles unter einem Dach.",
  ...
  },
  {
    ...
    description: "Unser Hauptsitz und Zentrale – von hier aus koordinieren wir alle Projekte in der Steiermark. Verwaltung, Lager und unser größtes Team.",
  ...
  },
  {
    ...
    description: "Unsere Filiale in Kärnten – damit wir auch südlich der Alpen schnell vor Ort sind. Ihr regionaler Ansprechpartner für alle Gewerke.",
              ...
              {standorte.map((s, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`rounded-xl px-4 py-3 sm:px-5 sm:py-4 backdrop-blur-lg transition-all duration-300 ${
                      isActive
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`text-[9px] font-semibold uppercase tracking-widest px-2 py-0.5 rounded-full transition-colors duration-300 ${
                    ...
                    >
                      ...
                      <div className="space-y-2 mb-3">
                        <div className="flex items-center gap-2 text-xs text-muted">
                          <MapPin size={12} weight="light" className="text-primary flex-shrink-0" />
                          <span>{s.address}</span>
                        </div>
                        <div className="flex items-center gap-2 text-xs text-muted">
                          <Phone size={12} weight="light" className="text-primary flex-shrink-0" />
                          <a href={`tel:${s.phone.replace(/\s/g, "")}`} className="hover:text-primary transition-colors font-medium">
                            {s.phone}
                          </a>
                        </div>
                        <div className="flex items-center gap-2 text-xs text-muted">
                          <EnvelopeSimple size={12} weight="light" className="text-primary flex-shrink-0" />
                      ...
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 text-[11px] font-semibold text-primary hover:text-primary-hover transition-colors"
                      >
